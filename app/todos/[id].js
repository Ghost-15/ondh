...
export default function EditScreem() {
    ...
    return (
        ...
        <View style={styles.inputContainer}>
            ...
            <Pressable onPress={ () => setColorScheme(colorScheme === 'light' ? 'dark' : 'light')}
                       style={{ marginLeft: 10 }}>
                <Octicons name={colorScheme === 'dark' ? "moon" : "sun"} size={36} color={theme.text}
        ...
        <View style={styles.inputContainer}>
            ...
            >
                <Text style={[styles.saveButtonText, {Color: 'red'}]}>Cancel</Text>
            </Pressable>
        </View>
